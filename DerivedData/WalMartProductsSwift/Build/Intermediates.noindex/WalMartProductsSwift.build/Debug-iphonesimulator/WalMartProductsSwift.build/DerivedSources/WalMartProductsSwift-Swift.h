...
SWIFT_MODULE_NAMESPACE_PUSH("WalMartProductsSwift")
@class UIWindow;
@class UIApplication;
@class UISplitViewController;
@class UIViewController;

SWIFT_CLASS("_TtC20WalMartProductsSwift11AppDelegate")
...
SWIFT_CLASS("_TtC20WalMartProductsSwift20DetailViewController")
...
@interface Event (SWIFT_EXTENSION(WalMartProductsSwift))
...
SWIFT_CLASS("_TtC20WalMartProductsSwift20MasterViewController")
...
SWIFT_CLASS_NAMED("Page")
@interface Page : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface Page (SWIFT_EXTENSION(WalMartProductsSwift))
@property (nonatomic) int32_t pageID;
@end
...
@interface Product (SWIFT_EXTENSION(WalMartProductsSwift))
...
@property (nonatomic, copy) NSString * _Nullable longDesc;
@property (nonatomic) int32_t pageID;
...
@property (nonatomic) double reviewRating;
@property (nonatomic, copy) NSString * _Nullable shortDesc;
@end
